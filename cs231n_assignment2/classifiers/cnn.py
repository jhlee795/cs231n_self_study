...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        W2_rows = num_filters * input_dim[1] / 2 * input_dim[2] / 2
        
        self.params['W2'] = np.random.normal(scale = weight_scale,size = (int(W2_rows), hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        loss += sum(0.5 * self.reg * np.sum(W_tmp * W_tmp) for W_tmp in [W1, W2, W3])
